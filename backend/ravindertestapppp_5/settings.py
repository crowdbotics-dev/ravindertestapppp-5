"""
Django settings for ravindertestapppp_5 project.
...
ROOT_URLCONF = 'ravindertestapppp_5.urls'
...
WSGI_APPLICATION = 'ravindertestapppp_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ravindertestapppp_5 API",
    "DESCRIPTION": "API documentation for ravindertestapppp_5 App",
    "VERSION": "v1",
}
